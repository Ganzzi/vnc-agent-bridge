...
def run_websocket_diagnostics():
    ...
    proxmox_vnc_port = int(os.getenv("WEBSOCKET_VNC_PORT", "5900"))

    print(f"Environment variables:")
    print(f"  WEBSOCKET_VNC_HOST: {proxmox_host}")
    print(f"  WEBSOCKET_VNC_HOST_PORT: {proxmox_port}")
    print(f"  WEBSOCKET_VNC_NODE: {proxmox_node}")
    print(f"  WEBSOCKET_VNC_VMID: {proxmox_vmid}")
    print(f"  WEBSOCKET_VNC_TICKET: {'Set' if vnc_ticket else 'Not set'}")
    print(f"  WEBSOCKET_VNC_CERTIFICATE_PEM: {'Set' if certificate_pem else 'Not set'}")
    ...
    if successful_configs:
        ...
        print("      - WEBSOCKET_VNC_HOST=your.proxmox.host")
        print("      - WEBSOCKET_VNC_HOST_PORT=8006")
        print("      - WEBSOCKET_VNC_NODE=your-node-name")
        print("      - WEBSOCKET_VNC_VMID=vm-id")
        print("      - WEBSOCKET_VNC_TICKET=your-ticket")
        print("      - WEBSOCKET_VNC_CERTIFICATE_PEM=your-certificate-pem-string")
        print("      Note: WebSocket VNC uses ticket-based authentication")
