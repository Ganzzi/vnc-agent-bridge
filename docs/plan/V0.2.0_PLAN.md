...
- [ ] Implement capture_region() method
- [ ] Implement save() with multiple formats
- [ ] Implement save_region() method
- [ ] Add PIL Image conversion
- [ ] Add bytes export for API responses
- [ ] Unit tests for all methods
- [ ] Integration tests with mock framebuffer
- [ ] Test all image formats (PNG, JPEG, BMP)
...
| Task | Priority | Est. Hours | Status |
|------|----------|------------|--------|
| Create ScreenshotController class | High | 4h | Not Started |
| Implement capture() method | High | 3h | Not Started |
| Implement capture_region() method | High | 3h | Not Started |
| Implement save() method | High | 3h | Not Started |
| Implement save_region() method | High | 2h | Not Started |
| Add PIL Image conversion | High | 2h | Not Started |
| Support PNG format | High | 1h | Not Started |
| Support JPEG format | Medium | 1h | Not Started |
| Support BMP format | Low | 1h | Not Started |
| Unit tests for ScreenshotController | High | 6h | Not Started |
| Integration tests | High | 4h | Not Started |
| Performance testing | Medium | 2h | Not Started |
| **Total** | | **32h** | |
